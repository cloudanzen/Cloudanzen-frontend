...
import { accessManagementService, type AccessAccount } from '@/services/api/access-management';
        ...
        <div className="space-y-3">
          <div className="text-sm">
            ...
            {account.accountEmail && (
              <span className="text-muted-foreground"> ({account.accountEmail})</span>
            )}
          </div>
              ...
              filtered.map((u) => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 text-sm hover:bg-muted border-b last:border-0 ${
                    u.id === account.mappedUserId ? 'bg-primary/5 font-medium' : ''
                  }`}
