...
export const FRAMEWORK_CATALOG: Record<string, FrameworkCatalogEntry> = {
  'iso-27001': {
    ...
    industries: ['Technology', 'Finance', 'Healthcare', 'Manufacturing', 'Government', 'Professional Services'],
    scope: ['Information assets inside the ISMS boundary', 'Statement of Applicability and Annex A control selection'],
    benefits: ['Widely recognized certification', 'Disciplined risk management program', 'Strong foundation for SOC 2, HIPAA, and other mapped frameworks'],
    controlDomains: [
  ...
  'soc-2': {
    ...
    industries: ['SaaS / Cloud', 'Technology', 'Finance', 'Healthcare IT', 'Managed Service Providers'],
    scope: ['Systems storing or processing customer data', 'Applicable Trust Services Criteria', '6-12 month observation period for Type II'],
    benefits: ['Common procurement requirement for enterprise deals', 'Reduces security questionnaire burden', 'Signals operational maturity to customers and investors'],
    controlDomains: [
  ...
  'nist-csf': {
    ...
    industries: ['Government', 'Defense', 'Critical Infrastructure', 'Finance', 'Healthcare', 'Energy'],
    scope: ['Cybersecurity risk management processes', 'Supply chain and third-party risk'],
    benefits: ['Strong alignment with US public-sector expectations', 'Flexible outcome-based model', 'Maps cleanly to ISO 27001 and SOC 2'],
    controlDomains: [
  ...
  hipaa: {
    ...
    industries: ['Healthcare', 'Health IT / Digital Health', 'Health Insurance', 'Medical Devices', 'Telehealth'],
    scope: ['All ePHI created, received, maintained, or transmitted', 'Covered entities and business associates with PHI access'],
    benefits: ['Required for handling US patient health data', 'Supports Business Associate Agreements', 'Reduces OCR enforcement and breach risk'],
    controlDomains: [
